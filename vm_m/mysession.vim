...
badd +25 srcs/tools.c
badd +46 srcs/clear.c
badd +44 srcs/get_champions.c
badd +16 srcs/main.c
badd +1 Makefile
badd +73 srcs/check_byte_code.c
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 88 - ((69 * winheight(0) + 35) / 70)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 74 - ((29 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 91 - ((61 * winheight(0) + 35) / 70)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
