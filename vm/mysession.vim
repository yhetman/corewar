...
badd +0 srcs/clear.c
badd +50 includes/corewar.h
badd +0 srcs/execute_champs_code.c
badd +52 srcs/check_byte_code.c
badd +54 srcs/carriages_placement.c
badd +0 srcs/tools.c
argglobal
silent! argdel *
argadd Makefile
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((44 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((44 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
