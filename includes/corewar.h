...
/*   Updated: 2019/10/30 16:14:07 by yhetman          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					long_into_bytes(unsigned char *arena, long addr,
						long value, long size);
long					check_option_params(t_vm *vm, t_carriage *car,
						bool turn, unsigned short i);
long					bytes_into_long(const unsigned char *arena,
...
void					code_validation(t_vm *vm, t_carriage *carr,
						t_op *option);
